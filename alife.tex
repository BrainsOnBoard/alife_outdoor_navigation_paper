...
While our ANN-based algorithms have been tested in simulations of ant habitats, they have not yet been tested in the real world.  
...
\end{align}
%
The weights are then adjusted using: 
%
\begin{align}
