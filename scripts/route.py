...
def load_route(route_path, image_input="unwrapped"):
    # Read decimate script
    decimate_filename = path.join(route_path, "decimate.sh")
    ...
    # Read CSV route
    route_data_filename = path.join(route_path, image_input, "database_entries.csv")
